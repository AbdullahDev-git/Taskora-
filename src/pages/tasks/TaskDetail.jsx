...
const TaskDetailContent = () => {
  ...
  return (
    <div className="p-8">
      ...
      <button
        onClick={() => navigate("/tasks")}
        className="flex items-center gap-2 text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium mb-6"
      >
        <ArrowLeft size={20} />
        Back to Tasks
      </button>
      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="col-span-2 space-y-6">
          ...
          <div className="card p-8">
            ...
            <div className="py-6 border-t border-gray-200 dark:border-dark-border">
              ...
              <p className="text-gray-600 dark:text-dark-text2 whitespace-pre-wrap">
        ...
        <div className="space-y-6">
          ...
          <div className="card p-6">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-dark-text2 uppercase mb-3">
              Status
            </h3>
          ...
          <div className="card p-6 space-y-4">
            {/* Type */}
            <div>
              <h4 className="text-sm font-semibold text-gray-700 dark:text-dark-text2 uppercase mb-2">
                Type
              </h4>
              <p className="text-gray-900 dark:text-dark-text">{task.type}</p>
            </div>
