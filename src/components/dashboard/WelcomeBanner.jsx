...
const WelcomeBanner = ({ userName, tasks = [] }) => {
  ...
  return (
    <div className="card p-8 bg-gradient-to-br from-primary-600 to-primary-800 text-white relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="text-right">
            ...
            <p className="text-sm text-primary-100">Efficiency</p>
          </div>
        </div>
